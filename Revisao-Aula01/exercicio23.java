...
public class exercicio23 {
    public static void main(String[] args) {
        ...
        String buscaNome=null, buscaTelefone=null;
        Integer opcao = 1;
        ...
        do {
            ...
            System.out.println("- 5-VERIFICAR SE EXISTE TELEFONE NA AGENDA");
            ...
            switch (opcao) {
                ...
                case 4:
                    System.out.print("\n\n- Digite o nome a ser buscado: ");
                    buscaNome = sc.nextLine();
                    if (agendaContatos.containsKey(buscaNome)) {
                        System.out.println("- O nome buscado existe na agenda.");
                    }
                    else {
                        System.out.println("- O nome buscado não existe na agenda.");
                    }
                    break;
                
                case 5:
                    System.out.print("\n\n- Digite o telefone a ser buscado: ");
                    buscaTelefone = sc.nextLine();
                    if (agendaContatos.containsValue(buscaTelefone)) {
                        System.out.println("- O telefone buscado existe na agenda.");
                    }
                    else {
                        System.out.println("- O telefone buscado não existe na agenda.");
                    }
                    break;
